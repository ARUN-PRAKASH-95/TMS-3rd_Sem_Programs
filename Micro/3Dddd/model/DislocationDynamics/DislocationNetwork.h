...
//#endif
            ...
            totalTime+=dt;
            //const MatrixDimD pdr(); // move may limit velocity, so compute pdr after move
            _plasticDistortionRate=computePlasticDistortionRate();
            plasticDistortion += _plasticDistortionRate*dt;
    ...
    public:
       ...
       std::pair<int,double> get_vmaxnodenumber() const
        ...
        { // TO DO: move this to DislocationNetworkIO.h
            ...
            EDR.readScalarInFile(fullName.str(),"outputNodalVelocity",DislocationNetworkIO<DislocationNetworkType>::outputNodalVelocity);
...
#pragma omp parallel for
        ...
        /**********************************************************************/
        MatrixDimD computePlasticDistortionRate() const
        {
